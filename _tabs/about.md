...
<blockquote style="font-style: italic; border-left: 0px solid #ccc; padding-left: 16px; margin: 20px 0; color: #444;">
  " Et Dieu,le mec a dû séché ses cours de cryptographie , resultats:prophetes,guerres,religions. Bordel une putain de paire de clées mathématiquement liées aurait suffi."
